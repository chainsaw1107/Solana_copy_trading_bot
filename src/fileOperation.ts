...
export async function fileOperation(trade_log: any) {
  ...
  //   }
  // }
  filename = filename + getFormattedDate() + '.txt';
  fs.writeFileSync(filename, JSON.stringify(trade_log));
